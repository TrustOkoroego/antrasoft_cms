...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-plus"></i> New Album <small></small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <button  id="addnewslide" class="btn btn-success"><i class="fa fa-plus"></i> Upload Image </button>
                        <button  onclick="window.location='{{URL::to('/')}}/admin/albums'" class="btn btn-success"><i class="fa fa-arrow-left"></i> Back </button>
                    </li>
                </ul>
